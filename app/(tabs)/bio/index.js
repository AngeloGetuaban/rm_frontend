...
const index = () => {
  ...
  const updateUserDescription = async () => {
    try {
      const response = await axios.put(`https://rmbackend-production.up.railway.app/users/${userId}/description`, {
  ...
  const addLookingFor = async (lookingFor) => {
    try {
      const response = await axios.put(`https://rmbackend-production.up.railway.app/users/${userId}/looking-for`, {
  ...
  const removeLookingFor = async (lookingFor) => {
    try{
      const response = await axios.put(`https://rmbackend-production.up.railway.app/users/${userId}/looking-for/remove`, {
          lookingFor:lookingFor,
      });
  ...
  const addPreference = async (preferences) => {
    try {
      const response = await axios.put(`https://rmbackend-production.up.railway.app/users/${userId}/preferences/add`,
        {
  ...
  const removePreference = async (preferences) => {
    try {
      const response = await axios.put(`https://rmbackend-production.up.railway.app/users/${userId}/preferences/remove`, {
        preferences: preferences
      });
  ...
  const handleAddImage = async () => {
    try{
      const response = await axios.post(`https://rmbackend-production.up.railway.app/users/${userId}/profile-images`, {
        imageUrl:imageUrl
      });
