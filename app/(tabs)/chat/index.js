...
const index = () => {
  ...
  const fetchReceivedLikesDetails = async () => {
    try{
      const response = await axios.get(
        `https://rmbackend-production.up.railway.app/received-likes/${userId}/details`
      );
  ...
  const fetchUserMatches = async () => {
    try{
      const response = await axios.get(`https://rmbackend-production.up.railway.app/users/${userId}/matches`);
